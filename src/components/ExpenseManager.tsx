    ...
    window.setTimeout(() => {
      const targetId =
        window.innerWidth < 768
          ? `expense-mobile-${nextHighlightedId}`
          : `expense-${nextHighlightedId}`;
          ...
          <div className="mt-5 space-y-4">
            <label className="block text-sm font-medium text-ink">
              ...
              <DateInput
                ...
                className="mobile-expense-date-input box-border block w-full min-w-0 max-w-full rounded-md border border-stone-300 bg-white px-3 py-3 text-sm outline-none transition focus:border-pine focus:ring-2 focus:ring-pine/20 sm:py-2"
              />
            </label>
            ...
            <label className="block text-sm font-medium text-ink">
              ...
              <span className="mt-1 block text-xs font-normal text-stone-500">
                可选。支持 jpg、jpeg、png、webp 和 pdf，保存支出后自动关联。
              </span>
              {evidenceFile ? (
                ...
                >
                  ...
                  <dl className="mt-4 grid grid-cols-1 gap-3 text-sm">
                    <div className="flex justify-between gap-4">
                      <dt className="shrink-0 text-stone-500">支付方式</dt>
                      <dd className="break-words text-right text-stone-700">
                        {expense.payment_method || "-"}
                      </dd>
                    </div>
                    <div className="flex justify-between gap-4">
                      <dt className="shrink-0 text-stone-500">收款方</dt>
                      <dd className="break-words text-right text-stone-700">
                        {expense.payee || "-"}
                      </dd>
                    </div>
